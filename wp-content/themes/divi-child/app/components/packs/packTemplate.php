...
<div id="packs" ng-controller="PackController as packCtrl" class="pack-component animate-visibility" ng-init="packCtrl.init(<?php echo get_packs(); ?>)" ng-show="packCtrl.isVisible()">
    ...
    <p ng-show="packCtrl.isPacksListVisible()">Es necesario que adquieras clases para poder reservar.</p>
    <p ng-show="!packCtrl.isPacksListVisible()">
        ¡Ahora cuentas con clases disponibles. Ya puedes reservar tu bici!
    </p>
    <a href="<?php echo site_url('reserva'); ?>" ng-show="!packCtrl.isPacksListVisible()" class="button-blue">Reserva ahora</a>
