    ...
    <div class="payment-wrapper">
            ...
            <div class="no-card" ng-if="!paymentCtrl.hasPrimaryCard()" ng-class="{ true: 'active', false: ''}[paymentCtrl.isNewCardActive()]" ng-mouseover="paymentCtrl.setNewCardFormStatus(true)" ng-mouseout="paymentCtrl.setNewCardFormStatus(false)">
                ...
                <div class="card-info">
                    <form novalidate name="paymentCtrl.newCardForm" class="form" ng-submit="paymentCtrl.saveCard()">
                        ...
                        <div class="card-info-row">
                            <div class="card-info-cell full-width">
                                <a class="button-blue" ng-click="paymentCtrl.processingPayment || paymentCtrl.processPayment()" ng-class="{ true: '', false: 'disabled' }[paymentCtrl.newCardForm.$valid]" ng-disabled="!paymentCtrl.newCardForm.$valid"><span class="icon-lock"></span>&nbsp;&nbsp;guardar y pagar</a>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="cart-section">
            ...
            <div class="border-container">
                ...
                <a class="button-blue" ng-if="paymentCtrl.hasPrimaryCard()" ng-click="paymentCtrl.processingPayment || paymentCtrl.processPayment()" ng-class="{ true: 'disabled', false: '' }[paymentCtrl.processingPayment]" ng-disabled="paymentCtrl.processingPayment">Pagar</a>
            </div>
        </div>
    </div>
