...
nbici.controller('LoginController', ['$rootScope', '$scope', '$timeout', 'SessionService', 'LoginService', 'LoggerService', 'UtilsService', 'usSpinnerService', function($rootScope, $scope, $timeout, SessionService, LoginService, LoggerService, UtilsService, usSpinnerService){
