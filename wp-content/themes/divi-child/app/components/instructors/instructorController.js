...
nbici.controller('InstructorController', ['$scope', 'InstructorService', 'UtilsService', 'DEFAULT_VALUES', function($scope, InstructorService, UtilsService, DEFAULT_VALUES){
