...
<div id="booking" class="booking-component animate-visibility" ng-controller="BookingController as bookingCtrl" ng-show="bookingCtrl.isVisible()">
    ...
    <div ng-if="bookingCtrl.classroomIsFull()">
        <div ng-if="bookingCtrl.isWaitingListOpen()">
            ...
            <button class="button-blue" ng-click="bookingCtrl.bookWaitingList()" style="margin: 20px 0;">Unirme a la lista de espera</button>
            <div class="actions">
        ...
        <div ng-if="!bookingCtrl.isWaitingListOpen()">
            ...
            <div style="margin: 30px 0; font-weight: normal;">La lista de espera ya está cerrada, pero muy probable que alguien no asista a la clase y podamos darte su bici.</div>
            <div class="actions">
                <a href="" class="close-link" ng-click="bookingCtrl.closeClassroom()">Regresar a los horarios</a>
            </div>
        </div>
