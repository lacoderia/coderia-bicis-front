...
nbici.factory('PaymentService', ['$http', '$q', '$rootScope', 'SessionService', 'LoggerService', 'API_URL_BASE', function($http, $q, $rootScope, SessionService, LoggerService, API_URL_BASE){
