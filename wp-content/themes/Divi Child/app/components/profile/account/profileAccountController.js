...
nbici.controller('AccountController', ['$scope', '$filter', 'SessionService', 'AccountService', 'HistoryService', 'LoggerService', 'usSpinnerService', function($scope, $filter, SessionService, AccountService, HistoryService, LoggerService, usSpinnerService){
     ...
     * @returns {*}
     */
    accountCtrl.getUserStreamingClassesLeft = function() {
