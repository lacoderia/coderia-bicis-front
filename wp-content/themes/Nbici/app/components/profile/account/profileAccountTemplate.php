...
<div ng-controller="AccountController as accountCtrl" class="account-module"> 
    ...
    <form novalidate name="accountCtrl.resetForm" class="form special-form active" ng-submit="accountCtrl.updatePassword()">
        ...
        <div class="info">
            <div class="info-row">
                <div style="font-size: 0.8rem; font-weight: 700;" ng-show="accountCtrl.userIsSynced()">La contraseña también se actualizará en tu cuenta de Nbox</div>
            </div>
            <div class="info-row">
                <div class="info-cell full-width">
            ...
            <div class="info-row">
                <div class="info-cell full-width">
                    <button class="button-blue">cambiar contraseña</button>
                </div>
            </div>
        </div>
    </form>
