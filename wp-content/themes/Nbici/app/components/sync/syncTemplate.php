...
<div id="sync" ng-controller="SyncController as syncCtrl" class="sync-component animate-visibility" ng-init="syncCtrl.init()">
    ...
    <div ng-show="syncCtrl.userIsSynced()">
        ...
        <a href="<?php echo site_url('reserva'); ?>" class="cool-button">Reserva ahora</a>
    </div>
    <div ng-show="!syncCtrl.userIsSynced()">
        <h2>¿Qué beneficios obtienes al sincronizar tu cuenta?</h2>
        <p>Al sincronizar tu cuenta con Nbox podrás usar tus clases para reservar entrenamientos en Nbox o clases en NBici. En tres sencillos pasos puedes disfrutar de este beneficio:</p>
        <div class="steps-maxi-container">
            <step ng-show="syncCtrl.showStep(0)">
                <h3>1. Inicia sesión con tu cuenta de Nbox</h3>
                <div class="step-container">
                    <p>Primero necesitamos validar tu usuario de Nbox</p>
                    <form novalidate name="syncCtrl.loginForm" class="form" ng-submit="syncCtrl.remoteLogin()">
                        ...
                        <fieldset>
                            ...
                            <a href="<?php echo $nbox_url; ?>?view=signup" ng-click="loginCtrl.showView(loginCtrl.VIEWS.LOGIN)">¿No tienes cuenta en Nbox?</a>
                        </fieldset>
                    </form>
                </div>
            </step>
