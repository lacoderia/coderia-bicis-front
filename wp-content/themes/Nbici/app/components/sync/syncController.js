...
nbici.controller('SyncController', ['$scope', '$document', '$timeout', 'SessionService', 'SyncService', 'LoggerService', 'UtilsService', 'usSpinnerService', function($scope, $document, $timeout, SessionService, SyncService, LoggerService, UtilsService, usSpinnerService){
